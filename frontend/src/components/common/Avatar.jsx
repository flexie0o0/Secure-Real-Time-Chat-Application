    ...
    <>
      <div className="flex items-center justify-center">
        ...
        {type === "xl" && (
          ...
          >
            <div
              className={`bg-photopicker-overlay-background h-60 z-10 w-60 absolute top-0 lefft-0 flex items-center rounded-full justify-center flex-col text-center gap-2 ${
